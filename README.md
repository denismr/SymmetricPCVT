...
The following figures show the average number of times each cell was visited, in this case. The first show the number of visits por cell for varying inner radii and outer radius fixed at 30. The second has an outer radius fixed at 150.
