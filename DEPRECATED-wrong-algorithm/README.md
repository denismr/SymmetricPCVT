...
Years after publishing this code, I realized (thanks to testing by [Vivificient](https://www.reddit.com/user/Vivificient) that the algorithm was not truly symmetric as I had claimed.

I failed to conduct proper empirical testing at the time, and for that, I am deeply sorry. This folder remains as a reference implementation for (non-symmetric) Pre-computed Visibility Tries. It retains one specific advantage over the new version: it is more "permissive" and allows for incidental visibility.

The "Really Symmetric" (RSPCVT) version is much stricter and is now the primary implementation in the root directory of this repository.
